...
type AnalysisAction =
  ...
  | { type: "success"; report: ResumeIntelligenceReport }
...
export default function App() {
  ...
  async function runAnalysis(resume: File, jdText: string) {
    try {
      ...
      // Unified single call runs all three engines server-side:
      // ATS Compatibility + Content Quality + (optional) JD Match.
      const report = await analyzeResume(resume, jdText.trim() || undefined);
