...
export function UploadPage({ onAnalyze }: { onAnalyze: (resume: File | null, jdText: string) => void }) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <label className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-8 text-center cursor-pointer hover:border-accent transition">
            ...
            <p className="text-sm text-gray-500 mt-1">{resumeFile ? resumeFile.name : "PDF or DOCX"}</p>
          </label>
